...
import {
    ...
    Trophy, Layers, Zap, Headphones, ArrowRight
} from "lucide-react"
...
// ============================================================================
const services = [
    { icon: <Brain className="w-7 h-7" />, title: "Autonomous AI Agents", desc: "Deploy the proprietary Launch Pixel Agent. We don't just build LLM wrappers; we engineer cognitive digital workers that automate your core workflows." },
    { icon: <Code2 className="w-7 h-7" />, title: "Systems Engineering", desc: "React, Next.js, and Node architectures built for extreme scale." },
    { icon: <Smartphone className="w-7 h-7" />, title: "Market Positioning", desc: "We don't build brands. We engineer psychological monopolies." },
    { icon: <LayoutDashboard className="w-7 h-7" />, title: "Experience Design", desc: "UI/UX that feels less like software and more like an extension of thought." },
    { icon: <PenTool className="w-7 h-7" />, title: "Rapid Prototyping", desc: "High-fidelity motion prototypes. See the future before we write a line of code." },
    { icon: <BarChart2 className="w-7 h-7" />, title: "Search Dominance", desc: "Technical SEO strategies designed to aggressively capture market share." },
    { icon: <Book className="w-7 h-7" />, title: "Design Topography", desc: "Component libraries and tokens that ensure your brand speaks one language." },
    { icon: <IdCard className="w-7 h-7" />, title: "Visual Identity", desc: "Logos, palettes, and typography curated for premium authority." },
]
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {services.map((service, idx) => (
                            <div key={idx} className="service-card h-full">
                                <SpotlightCard className="p-8 h-full group bg-black/40 border-white/5">
                                    <div className="flex flex-col h-full">
                                        <div className="w-12 h-12 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-8 text-indigo-400 group-hover:scale-110 transition-transform duration-500 group-hover:bg-indigo-500/20">
                                            {service.icon}
                                        </div>
