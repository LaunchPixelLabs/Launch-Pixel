      ...
      <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center gap-6 mb-12 relative z-10">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h2 className="text-3xl font-sketch font-bold text-white tracking-tight">Active Matrix Links</h2>
          </div>
          <p className="text-sm text-zinc-500 font-sketch">Provision and assign neural uplink channels for synchronous communication.</p>
        </div>
        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
           <button className="flex-1 md:flex-none flex items-center justify-center gap-3 px-6 py-3 bg-white/5 border border-white/10 hover:border-[#FEED01]/50 text-white text-[10px] font-mono font-bold uppercase tracking-widest rounded-2xl transition-all">
             <CreditCard className="w-4 h-4 text-zinc-400" /> Subscription Matrix
           </button>
            ...
            <div className="flex gap-6 items-center">
               ...
               <div>
                  <div className="flex items-center gap-3 mb-1">
                    <span className="text-[10px] font-mono font-bold text-[#FEED01] uppercase tracking-[0.3em]">Master Uplink Node</span>
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest flex items-center gap-1">
                       <Globe className="w-3 h-3" /> US - Iowa Matrix
                    </span>
          ...
          <div className="bg-white/5 border border-white/5 rounded-3xl p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-500 font-sketch leading-relaxed">
                Links are synchronized via the Twilio matrix. Provisioning occurs in real-time, instantly mapping the synaptic stream to a physical number.
              </p>
            </div>
          </div>
          <div className="bg-white/5 border border-white/5 rounded-3xl p-6 flex items-start gap-4">
            ...
            <div>
              <p className="text-sm text-white font-sketch font-bold mb-1">Concurrency Matrix</p>
              <p className="text-[11px] text-zinc-500 font-sketch leading-relaxed">
                Standard nodes support 1,000 concurrent synaptic threads. Upgrade to the Titan Matrix for unlimited high-frequency burst capacity.
              </p>
            </div>
          </div>
        </div>
