...
const plans = [
  {
    name: "Solopreneur",
    description: "Perfect for freelancers and solo founders scaling outreach.",
    price: "14,999",
    period: "/mo",
    highlight: false,
    icon: Phone,
    ...
    features: [
      ...
      { text: "2 concurrent calls", included: true },
      { text: "3 knowledge base docs", included: true },
  ...
  {
    name: "Teams",
    description: "For growing sales teams that need serious firepower.",
    price: "19,999",
    period: "/person/mo",
    highlight: true,
    icon: Users,
    gradient: "from-zinc-700 to-zinc-800",
    borderColor: "border-zinc-500 hover:border-zinc-400",
    features: [
      { text: "5 AI Agents", included: true },
      { text: "2,000 minutes / month", included: true },
      { text: "10 concurrent calls", included: true },
      { text: "15 knowledge base docs", included: true },
      { text: "WhatsApp alerts", included: true },
      { text: "Special Perks (Expressive Mode, Agent Guards)", included: true },
  ...
  {
    name: "Enterprise",
    description: "Unlimited scale. Dedicated infrastructure. White-glove onboarding.",
    price: "???",
    period: "",
    highlight: false,
    icon: Building2,
    ...
    features: [
      ...
      { text: "WhatsApp + Slack + custom alerts", included: true },
      { text: "Custom dashboards & reporting", included: true },
      { text: "Dedicated account manager", included: true },
      { text: "Voice cloning + custom voices", included: true },
      { text: "Custom API integrations", included: true },
    ],
    cta: "Contact Us",
    ctaHref: "https://wa.me/917004635011?text=Hi%20Launch%20Pixel!%20I%27m%20interested%20in%20the%20Enterprise%20AI%20Agent%20plan.",
  },
]
